// Used for testing EtherEvent.send() overloading in ETHEREVENT_NO_AUTHENTICATION + ETHEREVENT_FAST_SEND mode
// Use with extras/tests/EventGhost-trees/EchoTCPEventsNoAuthentication.egtree
